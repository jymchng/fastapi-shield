...
class TestCustomStringTypes:
    ...
    def test_valid_api_key(self):
        ...
        response = self.client.get(
            "/api-key-protected", headers={"x-api-key": valid_key}
        )
        assert response.status_code == 200
    ...
    def test_invalid_api_key(self):
        ...
        invalid_key = "invalid"
        response = self.client.get(
            "/api-key-protected", headers={"x-api-key": invalid_key}
        )
    ...
    def test_valid_bearer_token(self):
        ...
        response = self.client.get(
            "/jwt-protected", headers={"authorization": valid_token}
        )
        assert response.status_code == 200
    ...
    def test_invalid_bearer_token(self):
        ...
        response = self.client.get(
            "/jwt-protected", headers={"authorization": invalid_token}
        )
        assert response.status_code == 500  # Default shield error
    ...
    def setup_method(self):
        ...
        try:
            ...
            async def create_user(
                validated_user: UserInput = ShieldedDepends(lambda user: user),
            ):
...
class TestStringTransformation:
    ...
    def setup_method(self):
        ...
        async def create_comment(
            sanitized_content: str = ShieldedDepends(lambda content: content),
        ):
            # Use the sanitized content
            return {"message": "Comment created", "content": sanitized_content}
    ...
    def test_sanitize_html(self):
        ...
        response = self.client.post("/comments", data={"content": html_content})
        assert response.status_code == 200
...
class TestRegexValidation:
    ...
    def setup_method(self):
        ...
        def regex_shield(pattern: str, error_message: str):
            ...
            def validator(request: Request):
                ...
                path = request.path_params.get("username") or request.path_params.get(
                    "product_id"
                )
    ...
    def test_invalid_username(self):
        ...
        assert response.json() == {
            "detail": "Username must be 3-20 alphanumeric characters or underscores"
        }
    ...
    def test_invalid_product_id(self):
        ...
        assert response.status_code == 400
        assert response.json() == {
            "detail": "Product ID must be in format PROD-XXXXXXXXXX (10 alphanumeric characters)"
        }
