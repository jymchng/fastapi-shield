...
def create_test_token(
    user_id: str, roles: List[str] = None, permissions: List[str] = None
):
...
class TestEcommerceAPI:
    ...
    def setup_method(self):
        ...
        self.redis_client.pipeline.return_value.execute.return_value = [
            None,
            None,
            0,
            None,
    ...
    def setup_routes(self):
        ...
        async def create_order(
            order_data: dict, auth_data=ShieldedDepends(lambda d: d)
        ):
            """Create a new order"""
    ...
    def test_create_product_with_permission(self):
        ...
        token = create_test_token(str(USER_ID_1), [UserRole.ADMIN], ["product:create"])
        product_data = {
            "name": "New Product",
            "price": 19.99,
            "description": "A new product",
    ...
    def test_update_product_with_permission(self):
        ...
        token = create_test_token(str(USER_ID_1), [UserRole.ADMIN], ["product:update"])
        product_id = "11111111-1111-1111-1111-111111111111"
    ...
    def test_delete_product_with_permission(self):
        ...
        token = create_test_token(str(USER_ID_1), [UserRole.ADMIN], ["product:delete"])
    ...
    def test_list_orders_customer(self):
        ...
        order_id = uuid4()
        ORDERS_DB[order_id] = Order(
            id=order_id, user_id=USER_ID_1, items=[], total=0.0, status="created"
        )
    ...
    def test_list_orders_admin(self):
        ...
        ORDERS_DB[order_id_1] = Order(
            id=order_id_1, user_id=USER_ID_1, items=[], total=0.0, status="created"
        )
        ORDERS_DB[order_id_2] = Order(
            id=order_id_2, user_id=USER_ID_2, items=[], total=0.0, status="created"
        )
    ...
    def test_cancel_order_with_permission(self):
        ...
        token = create_test_token(str(USER_ID_1), [UserRole.ADMIN], ["order:delete"])
        headers = {"Authorization": f"Bearer {token}"}
    ...
    def test_rate_limiting(self):
        ...
        async def test_rate_limit_shield(
            client_ip: str = Header(None, alias="X-Forwarded-For"),
        ):
