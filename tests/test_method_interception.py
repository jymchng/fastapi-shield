...
class TestConditionalShieldApplication:
    ...
    def test_development_mode_skips_auth(self):
        ...
        response = self.client.get(
            "/api/data",
            headers={"x-skip-auth": "development"}
        )
