...
class TestTokenAuthentication:
    ...
    def setup_method(self):
        ...
        HTTPAuthorizationCredentials = pytest.importorskip("fastapi.security").HTTPAuthorizationCredentials
    ...
    def test_token_generation(self):
        ...
        response = self.client.post("/token", params={"username": "johndoe", "password": "password123"})
        assert response.status_code == 200
    ...
    def test_invalid_credentials_for_token(self):
        ...
        response = self.client.post("/token", params={"username": "johndoe", "password": "wrongpassword"})
        assert response.status_code == 401
        assert response.json()["detail"] == "Invalid credentials"
